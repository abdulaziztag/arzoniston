  ...
  function SelectTrigger(props, ref) {
    ...
    return (
      <ChakraSelect.Control {...rest}>
        ...
        <ChakraSelect.IndicatorGroup className="h-10">
...
export const SelectValueText = React.forwardRef<
  HTMLSpanElement,
  SelectValueTextProps & { translatable?: boolean }
>(function SelectValueText(props, ref) {
  const { children, translatable = false, ...rest } = props;
    ...
    <ChakraSelect.ValueText {...rest} ref={ref}>
      <ChakraSelect.Context>
        {(select) => {
          ...
          if (items.length === 1)
            return translatable
              ? t(select.collection.stringifyItem(items[0]))
